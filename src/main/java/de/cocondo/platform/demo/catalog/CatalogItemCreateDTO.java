...
public class CatalogItemCreateDTO implements DataTransferObject {

    @NotBlank(message = "Catalog item sku must not be blank")
    @Size(max = 128, message = "Catalog item sku must not exceed 128 characters")
    private String sku;
    ...
    public CatalogItemCreateDTO(String sku, String name, String description) {
        this.sku = sku;
        this.name = name;
