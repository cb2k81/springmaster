...
- ADR-0008 bis ADR-0010 sind noch nicht akzeptiert. Konfigurations-, DB-Migrations-/DBTool- und Observability-Entscheidungen daher nicht als vollständig ADR-abgesichert darstellen.
