...
files=(
  ...
  'bin/patch.py'
  'patches/logs/root/CHANGELOG-000084_springmaster_patch_git_commit_script_index_guard.md'
...
git commit -m 'Apply 000084_springmaster_patch_git_commit_script_index_guard'
