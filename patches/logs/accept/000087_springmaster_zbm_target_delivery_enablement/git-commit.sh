...
files=(
  'patches/logs/target-registry/CHANGELOG-000087_springmaster_zbm_target_delivery_enablement.md'
  'platform/update/targets/zbm.env'
)
...
git commit -m 'Apply 000087_springmaster_zbm_target_delivery_enablement'
